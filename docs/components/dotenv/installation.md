...
3. Enter the `DotEnv` package URL: `https://github.com/chaqmoq/dotenv.git`.
...
5. Add the `DotEnv` package to your desired target of the `MyPackage` where you want to import and use it.
